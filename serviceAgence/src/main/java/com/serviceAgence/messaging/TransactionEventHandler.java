...
public class TransactionEventHandler {
     ...
     */
    @RabbitListener(queues = "user-transaction-queue")
    public void handleTransactionRequest(TransactionRequestEvent event) {
        ...
        try {
            // Conversion vers DTO
            TransactionRequest request = convertToTransactionRequest(event);
    ...
    /**
     * Conversion événement vers DTO avec récupération de l'agence
     */
    private TransactionRequest convertToTransactionRequest(TransactionRequestEvent event) {
